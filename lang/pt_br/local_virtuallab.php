...
$string['cannot_editor_elsewhere'] = 'Você já é editor em outro ambiente desta turma.';
$string['checklist_synced'] = 'Lista de tarefas aplicada a {$a} laboratório(s).';
$string['column_environment'] = 'Ambiente';
$string['column_lab'] = 'Laboratório';
$string['column_labs'] = 'Laboratórios';
$string['column_shortname'] = 'Nome breve';
$string['column_status'] = 'Status';
$string['confirm_become_editor'] = 'Tornar-se o editor de "{$a}"? Você não poderá editar outro ambiente desta turma enquanto não sair deste.';
...
$string['confirm_leave_lab'] = 'Sair de "{$a}"? Você perderá o acesso a este ambiente; se você era o editor, a vaga é liberada para outro estudante.';
...
$string['email_warning_body_multi'] = 'Os laboratórios abaixo serão {$a->action} automaticamente pela política de ciclo de vida, cada um na data indicada. Acesse-os ou reset-os antes disso se ainda precisar do conteúdo.';
...
$string['email_warning_editor_body_multi'] = 'O(s) laboratório(s) que você edita abaixo serão {$a->action} automaticamente, cada um na data indicada. Salve o que precisar antes disso.';
...
$string['leave_lab'] = 'Sair';
$string['leave_lab_label'] = 'Sair do laboratório: {$a}';
...
$string['privacy:export:batchteachers'] = 'Designação de professor responsável da turma';
$string['privacy:metadata'] = 'Informações sobre os professores responsáveis por cada turma do Lab Virtual.';
$string['privacy:metadata:batch_teachers:batchid'] = 'O ID da turma do Lab Virtual pela qual o professor é responsável.';
$string['privacy:metadata:batch_teachers:userid'] = 'O ID do usuário designado como professor responsável da turma.';
$string['report'] = 'Relatório';
$string['report_action_attempted'] = 'tentativa realizada';
$string['report_action_created'] = 'criado';
$string['report_action_deleted'] = 'excluído';
$string['report_action_downloaded'] = 'baixado';
$string['report_action_failed'] = 'reprovado';
$string['report_action_finished'] = 'concluído';
$string['report_action_graded'] = 'avaliado';
$string['report_action_started'] = 'iniciado';
$string['report_action_submitted'] = 'enviado';
$string['report_action_updated'] = 'atualizado';
$string['report_action_uploaded'] = 'enviado (arquivo)';
$string['report_action_viewed'] = 'visualizado';
...
$string['report_component_core'] = 'Curso';
...
$string['scheduled_action_delete'] = 'Programado: excluir em {$a}';
$string['scheduled_action_reset'] = 'Programado: resetar em {$a}';
