...
$string['role_batchmanager_desc'] = 'Permite que um professor responsável gerencie os laboratórios da própria turma — criar, resetar e excluir labs — e abra os cursos dos labs sem se inscrever.';
