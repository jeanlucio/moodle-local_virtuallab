...
$string['privacy:export:batchteachers'] = 'Batch teacher assignment';
$string['privacy:metadata'] = 'Information about the teachers responsible for each Virtual Lab batch.';
$string['privacy:metadata:batch_teachers:batchid'] = 'The ID of the Virtual Lab batch the teacher is responsible for.';
$string['privacy:metadata:batch_teachers:userid'] = 'The ID of the user assigned as a responsible teacher for the batch.';
