...
$string['role_batchmanager_desc'] = 'Allows a responsible teacher to manage the labs of their own batch — create, reset and delete labs — and to open the lab courses without enrolling.';
