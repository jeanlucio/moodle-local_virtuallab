...
$string['batch_keys'] = 'Enrolment keys';
...
$string['key_editor'] = 'Editor key';
$string['key_visitor'] = 'Visitor key';
...
$string['local/labvirtual:manage'] = 'Manage Lab Virtual (create batches and labs, reset, delete)';
$string['local/labvirtual:view'] = 'View Lab Virtual student panel';
$string['manage_batches'] = 'Manage Lab Virtual';
$string['manage_labs'] = 'Manage labs — {$a}';
$string['nobatches'] = 'No batches found. Create the first one using the form above.';
$string['nolabs'] = 'No labs found in this batch. Use the form above to create them.';
...
$string['settings_show_keys'] = 'Show enrolment keys in student panel';
$string['settings_show_keys_desc'] = 'When enabled, both enrolment keys (editor and visitor) are shown to authenticated students in the panel.';
