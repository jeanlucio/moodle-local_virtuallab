...
- The "Create labs" form is capped at 50 labs per request (validated in the form and the factory) to avoid creating a runaway number of courses in a single operation.
